...
function validateForm() {
  ...
  if (!validateName(userName.value)) {
    errors.push(
      "Invalid username. It should start with an uppercase letter and be 6 to 15 characters long."
    );
  }
  ...
  if (!validatePassword(password.value)) {
    errors.push(
      "Invalid Password. It should be at least 8 characters long and contain at least one special character."
    );
  }
